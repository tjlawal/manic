...
namespace Starlight {
	namespace Draw {
		...
		internal void draw_texel(Renderer *buffer, s32 x, s32 y, Vec4 point_a, Vec4 point_b, Vec4 point_c,  Texture2F32 a_uv, Texture2F32 b_uv, Texture2F32 c_uv,  u32 *texture, s32 texture_width, s32 texture_height);
