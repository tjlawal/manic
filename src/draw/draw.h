...
namespace Starlight {
	namespace Draw {
		...
		internal void draw_triangle_pixel(Renderer *buffer, s32 x, s32 y, Vec4F32 point_a, Vec4F32 point_b, Vec4F32 point_c, 
																			u32 colour);
		internal void draw_filled_triangle(Renderer *buffer, 
